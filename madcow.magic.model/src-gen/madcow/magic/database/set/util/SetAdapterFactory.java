 ...
 */
package madcow.magic.database.set.util;

import madcow.magic.database.core.MagicDBElement;

import madcow.magic.database.set.*;
 ...
 * <!-- end-user-doc -->
 * @see madcow.magic.database.set.SetPackage
 * @generated
 */
public class SetAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link madcow.magic.database.set.Set <em>Set</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link madcow.magic.database.set.Block <em>Block</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
