...
public interface Container extends CollectionElement {
	 ...
	 * The list contents are of type {@link madcow.magic.collection.CardInstance}.
	 * It is bidirectional and its opposite is '{@link madcow.magic.collection.CardInstance#getContainer <em>Container</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
