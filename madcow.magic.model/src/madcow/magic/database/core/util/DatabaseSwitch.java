 ...
 * $Id$
 */
package madcow.magic.database.core.util;
...
public class DatabaseSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DatabasePackage.MAGIC_DB_ELEMENT: {
				MagicDBElement magicDBElement = (MagicDBElement)theEObject;
				T result = caseMagicDBElement(magicDBElement);
			...
			case DatabasePackage.DATABASE: {
				...
				if (result == null) result = caseMagicDBElement(database);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
