...
public class SetFactoryImpl extends EFactoryImpl implements SetFactory {
	...
	public static SetFactory init() {
		try {
			SetFactory theSetFactory = (SetFactory)EPackage.Registry.INSTANCE.getEFactory("http://madcow.magic.database.set"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SetPackage.BLOCK: return createBlock();
			default:
