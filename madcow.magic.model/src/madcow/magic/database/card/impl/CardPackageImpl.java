...
public class CardPackageImpl extends EPackageImpl implements CardPackage {
	...
	public void initializePackageContents() {
		...
		EOperation op = addEOperation(cardEClass, ecorePackage.getEBoolean(), "parseType", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "typeString", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(cardEClass, ecorePackage.getEBoolean(), "parseManaCost", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "manaCostString", 0, 1, IS_UNIQUE, IS_ORDERED);
